              ...
              <ul className="KJH_if_left_bottom_content_section">
                {lastTwoProducts.map((product, index) => (
                  <li
                    key={index}
                    className={
                      lastTwoProducts.length === 1
                        ? "KJH_if_left_bottom_single-product"
                        : ""
                    }
                  >
                    <Link
                      to={`/detail/${product._id}`}
                      className="KJH_if_left_bottom_content_link_section"
                    >
        ...
        <div className="KJH_if_right_section">
          <div className="KJH_if_right_info">
            <div className="KJH_if_right_top_section">
              <div className="KJH_if_right_top_title">상점정보</div>
              <div className="KJH_if_right_top_content_section">
                <Link
                  to={`/mypageview/${seller._id}`}
                  className="KJH_if_right_shop-link"
                >
                  <div className="KJH_if_right_top_content_top">
                    ...
                    <div className="KJH_if_right_top_content_user_name">
                      ...
                      <div className="KJH_if_right_top_seller">
                        {seller.nickname}
                      </div>
                      ...
                      {review.length > 0 ? (
                        <>
                          {review.slice(0, 3).map((r, index) => (
                            <div
                              className="KJH_if_right_review_info"
                              key={index}
                            >
              ...
              <div
                ...
                className="KJH_if_right_bottom_section"
              >
              </div>
            </div>
          </div>
